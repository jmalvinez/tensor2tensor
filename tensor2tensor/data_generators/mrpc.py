...
_DEV_IDS = ("https://firebasestorage.googleapis.com/v0/b/"
            "mtl-sentence-representations.appspot.com/o/"
            "data%2Fmrpc_dev_ids.tsv?alt=media&token=ec5c0836-31d5-"
            "48f4-b431-7480817f1adc")
_MRPC_TRAIN = ("https://dl.fbaipublicfiles.com/senteval/senteval_data/"
              "msr_paraphrase_train.txt")
_MRPC_TEST = ("https://dl.fbaipublicfiles.com/senteval/senteval_data/"
...
def _maybe_download_corpora(tmp_dir):
  mrpc_dir = os.path.join(tmp_dir, _DATA_DIR)
  ...
  download_file(mrpc_dir, mrpc_train_finalpath, _MRPC_TRAIN)
  download_file(mrpc_dir, mrpc_test_finalpath, _MRPC_TEST)
  download_file(mrpc_dir, mrpc_dev_ids_finalpath, _DEV_IDS)
...
@registry.register_problem
class MSRParaphraseCorpusGenerateParaphrase(text_problems.Text2TextProblem):
